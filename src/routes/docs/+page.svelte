...
<div class="min-h-screen bg-[#050505] text-white">
  ...
  <header class="border-b border-[#1f1f1f]">
    <div
      class="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 text-xs font-mono uppercase tracking-[0.3em] max-sm:tracking-normal"
    >
      <a href="/" class="text-[#f97316] hover:underline">← Back to Ditto</a>
      <span class="text-gray-400 max-sm:hidden">Documentation</span>
    </div>
  </header>

  <main class="mx-auto max-w-6xl w-full">
    <div
      class="grid gap-12 px-4 py-12 lg:grid-cols-[250px_1fr] max-lg:gap-6 items-start"
    >
      <!-- Sidebar -->
      <aside
        class="sticky top-12 self-start h-fit space-y-2 max-lg:sticky max-lg:top-0 max-lg:z-10 max-lg:bg-[#050505] max-lg:py-3 max-lg:-mx-4 max-lg:px-4 max-lg:mb-6 max-lg:border-b max-lg:border-[#1f1f1f]"
      >
        ...
        <select
          ...
          class="block w-full rounded-lg border border-[#1f1f1f] bg-black/40 px-3 py-2 text-sm text-white focus:border-[#f97316] focus:outline-none lg:hidden"
        >
        ...
        <nav class="hidden space-y-2 lg:block">
          {#each sections as section}
            <a
              href={section.anchor}
      ...
      <div class="space-y-16">
        ...
        <section id="install" class="scroll-mt-12 space-y-4">
          ...
          <div class="rounded-2xl border border-[#1f1f1f] bg-black/40 p-6">
            ...
            <div class="mt-4 rounded-lg overflow-x-auto">
              <Highlight
                language={bash}
                code={`bun add ditto-ai
...
pnpm add ditto-ai`}
          ...
          <div
            class="space-y-4 rounded-2xl border border-[#1f1f1f] bg-black/40 p-6"
          >
            <h2 class="text-sm uppercase tracking-[0.3em] text-gray-500">
              Requirements
            </h2>
        ...
        <section id="api" class="scroll-mt-12 space-y-4">
          ...
          <div class="rounded-2xl border border-[#1f1f1f] bg-black/40 p-6">
            ...
            <div class="overflow-hidden rounded-lg">
              <Highlight
                language={typescript}
                code={`type Strategy = "consensus" | "cooperative";
          ...
          <div class="space-y-4">
            <div class="rounded-2xl border border-[#1f1f1f] bg-black/40 p-6">
              ...
              <div class="overflow-x-auto rounded-lg">
                <Highlight
                  language={typescript}
                  code={`import { dittoClient } from "ditto-ai";
              ...
              <div class="space-y-3 text-sm text-gray-300">
                ...
                <div>
                  ...
                  <p class="text-gray-400">
                    Each model's raw output: <span class="font-mono"
                      >{"@cf/meta/llama-3.1-8b-instruct"}</span
                    > → response
                  </p>
                </div>
                <div>
            ...
            <div class="rounded-2xl border border-[#1f1f1f] bg-black/40 p-6">
              ...
              <div class="space-y-3 text-sm text-gray-300">
                <div>
                  ...
                  <p class="text-gray-400">
                    <strong>Required.</strong> Cloudflare AI binding. Must have
                    <span class="font-mono">.run(model, {"{ prompt }"})</span> method.
                  </p>
                </div>
                <div>
                  <p class="font-mono text-[#f97316]">env.DITTO_JOB</p>
                  <p class="text-gray-400">
                    <strong>Required.</strong> Durable Object namespace for per-request
                    job orchestration. Provides extreme durability and idempotency.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="space-y-4">
            <div class="rounded-2xl border border-[#1f1f1f] bg-black/40 p-6">
              ...
              <div class="overflow-x-auto rounded-lg">
                <Highlight
                  language={typescript}
                  code={`class DittoError extends Error {
  ...
  details?: unknown;      // Additional context
            ...
            <div class="rounded-2xl border border-[#1f1f1f] bg-black/40 p-6">
              ...
              <div class="overflow-x-auto rounded-lg">
                <Highlight
                  language={typescript}
                  code={`import { dittoClient, DittoError } from "ditto-ai";
        ...
        <section id="merging" class="scroll-mt-12 space-y-4">
          ...
          <div class="space-y-4">
            <div class="rounded-2xl border border-[#1f1f1f] bg-black/40 p-6">
              ...
              <div class="space-y-3 text-sm text-gray-300">
                <p>
                  All models answer the same prompt. Responses are analyzed for
                  intent and merged into a single output.
                </p>
                <div class="overflow-x-auto rounded-lg">
                  <Highlight
                    language={bash}
            ...
            <div class="rounded-2xl border border-[#1f1f1f] bg-black/40 p-6">
              ...
              <div class="space-y-3 text-sm text-gray-300">
                ...
                <div class="overflow-hidden rounded-lg">
                  <Highlight
                    language={typescript}
                    code={`summary: string;           // Merged output, max 5 sentences
...
supportingModels: string[]; // Which models voted for winning intent`}
            ...
            <div class="rounded-2xl border border-[#1f1f1f] bg-black/40 p-6">
              ...
              <p class="text-sm text-gray-300 mb-3">
                Models execute sequentially, with each model seeing all previous
                outputs. Perfect for multi-step workflows where models build on
                each other's work.
              </p>
              <div class="overflow-x-auto rounded-lg">
                <Highlight
                  language={typescript}
                  code={`// Model 1 gets: "What is 2+2?"
  ...
  return response.result;
            ...
            <div class="rounded-2xl border border-[#1f1f1f] bg-black/40 p-6">
              ...
              <div class="overflow-x-auto rounded-lg">
                <Highlight
                  language={typescript}
                  code={`async function moderateContent(text: string) {
  const response = await ditto({
  ...
  return { action: "allow" };
            ...
            <div class="rounded-2xl border border-[#1f1f1f] bg-black/40 p-6">
              ...
              <div class="overflow-x-auto rounded-lg">
                <Highlight
                  language={typescript}
                  code={`async function analyzeDocument(document: string) {
  ...
  return response.result;
            ...
            <div class="rounded-2xl border border-[#1f1f1f] bg-black/40 p-6">
              ...
              <div class="overflow-x-auto rounded-lg">
                <Highlight
                  language={typescript}
                  code={`async function extractData(document: string) {
  const response = await ditto({
...
Answer with ONLY the company name.\`,
  ...
  return {
    ...
    confidence: response.structured?.confidence
        ...
        <section
          class="mt-20 rounded-2xl border border-[#1f1f1f] bg-black/40 p-8"
        >
          <h2 class="text-2xl font-semibold">Questions?</h2>
          <p class="mt-2 text-gray-400">
            Check the
            <a
              href="https://github.com/ditto-run/ditto-ai/issues"
              target="_blank"
              rel="noreferrer"
              class="text-[#f97316] hover:underline">GitHub issues</a
            >
            or open a new one.
          </p>
        </section>
